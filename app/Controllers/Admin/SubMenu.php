...
class SubMenu {
	...
	public function register_sub_menu() {
		...
		add_submenu_page(
			self::MENU_PAGE_SLUG,
			esc_html__( 'Disable Size', 'tsmlt-media-tools' ),
			'<span class="tsmlt-is-submenu" ><span class="dashicons dashicons-arrow-right-alt" ></span>' . esc_html__( 'Disable Size', 'tsmlt-media-tools' ) . '</span>',
			self::MENU_CAPABILITY,
			$menu_link_part . '#/disableSize'
		);
		add_submenu_page(
			self::MENU_PAGE_SLUG,
