                ...
                alignItems: 'center'
                    ...
                    >
                        <Title level={5} style={{
                            ...
                            <br/>
                           CSV File Accepted Column Header <Text strong>( ID, slug, url, title, caption, description, alt_text, custom_meta:_custom_meta_key, custom_meta:_meta_key_2, custom_meta:_meta_key_2  )</Text>
                        </Title>
