    ...
    return (
        ...
        >
            <div className="px-6 py-5 h-125 overflow-y-auto">
                <h5 className="text-[15px]! mt-0! font-semibold text-red-600 mb-4">
                    Important Notice: Prioritize data safety. Always back up files before deletion to avoid irreversible loss.
                </h5>
                <hr className="border-gray-200 my-3" />

                <h5 className="text-[15px]! mt-0! font-semibold text-green-600 mb-4">What is Rubbish File?</h5>
                ...
                <h5 className="text-[15px]! mt-0! font-semibold text-green-600 mb-4">Why Need Delete Rubbish File?</h5>
                ...
                <h5 className="text-[15px]! mt-0! font-semibold text-green-600 mb-4">Delete File Can be Restore?</h5>
                <p className="text-sm! text-gray-700 mb-2">
