    ...
    return (
        ...
        >
            ...
            <Content style={{ height: "500px", position:'relative', 'overflowY': 'auto', padding:'0' }} >
                ...
                <Divider style={{  margin: '10px 0'  }}/>
                <Paragraph type="secondary" style={{ fontSize: '14px', color:'#333'}}>
                    <Checkbox onChange={ ( event ) => event.target.checked ? localStoreData("showRubbishNotice", 'disable') : localStorage.removeItem("showRubbishNotice") }>
                        <span style={{color:'green'}}> Hide Notice For Today </span>
                    </Checkbox>
                </Paragraph >
