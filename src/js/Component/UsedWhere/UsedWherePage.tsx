        ...
        <div className="mx-auto px-6 py-8 min-h-screen bg-gray-50">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-2">
                    <h1 className="text-2xl font-semibold text-gray-900 m-0!">Media Usage/Un-Used Finder</h1>
                                            ...
                                            {activeFilter !== 'trash' && (
                                                <>
                                                    {(() => {
                                                        ...
                                                        // Per-type breakdown lives in the expanded list (click the
                                                        // row); the summary stays clean with just two pills.
                                                        return (
